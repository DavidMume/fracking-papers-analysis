...
> This is the full paper-by-paper analysis (English + Spanish). The condensed,
> bilingual, interactive version — with charts, findings cards, sources table
> and a case-study map — lives in the website built from this repository. See
> the main [README](../README.md) for how to run it.
